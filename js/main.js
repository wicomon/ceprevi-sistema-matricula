var btn_cargar = document.getElementById('btn_cargar_usuarios'),
	...
	sciclo = document.getElementById('sciclo');
...
function cargarUsuarios(){
	tabla.innerHTML='<tr><th>Código</th><th>A. Paterno</th><th>A. Materno</th><th>Nombres</th><th>Carrera</th></tr>';

	var peticion = new XMLHttpRequest();
	peticion.open('GET','aulas-datos.php');
	...
	peticion.onload= function(){
		...
		if (datos.error) {
			...
			for (var i = 0; i < datos.length ; i++) {
				...
				elemento.innerHTML += ("<td>" + datos[i].nombres + "</td>");
